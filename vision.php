...
<main>
      <div >
        <h1 style="text-align: center; color:#580F3C; font-family: times new roman;">OUR VISION</h1>
        <p style="text-align: center; color:black; font-family: times new roman; font-size: 2rem;">Uplifting Jesus in our generation as we transform lives and society</p>
      </div >
      <div >
        <h1 style="text-align: center; color:#580F3C; font-family: times new roman;">OUR MISSION</h1>
        <p style="text-align: center; color:black; font-family: times new roman;font-size: 2rem;">Is to be a ministry transforming multitudes of lives around the globe with the power of God's Word, Faith, Love and the pursuit of Excellence</p>
      </div>
